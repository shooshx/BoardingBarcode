...
#else
    int* charmap = malloc(src_len * 2 * sizeof(int));
    int* typemap = malloc(src_len * 2 * sizeof(int));
    int* blockmap[2];//[src_len];
    blockmap[0] = malloc(src_len * sizeof(int));
    blockmap[1] = malloc(src_len * sizeof(int));
#endif
...
#else
    unsigned int* data_part = malloc((data_blocks + 3) * 4);
    unsigned int* ecc_part = malloc((ecc_blocks + 3) * 4);
#endif
